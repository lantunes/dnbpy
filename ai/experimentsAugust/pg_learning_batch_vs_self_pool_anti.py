...
base_path = "/Users/u6042446/Desktop/dnbpy/ai/"
...
for episode_num in range(1, num_episodes + 1):
    ...
    while not game.is_finished():
        ...
        if current_player == 'policy':
            ...
            for_test.append(game.get_tensor_representation(current_player))
            ...
            for_test_2.append(game.get_tensor_representation(current_player))
            state_tensor = np.concatenate(game.get_tensor_representation(current_player), axis=3)
