...
def select_edge_with_anti(pol, anti_pol, board_state, epsilon, tensor_state):
    ...
    #else:
    policy_prob_map = pol.get_action_probs_input_channel(board_state,tensor_state,normalize_action_probs_with_softmax)
    anti_policy_prob_map = anti_pol.get_action_probs_input_channel(board_state,tensor_state,normalize_action_probs_with_softmax)
