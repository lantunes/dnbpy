...
episodes_per_thread = [14, 14, 14, 14, 14, 15, 15]
...
curr_policy = PGPolicyCNN2(board_size, batch_size=batch_size)
...
def run_episodes(num_episodes_per_thread, existing_params):
    pol = PGPolicyCNN2(board_size, batch_size=batch_size, existing_params=existing_params)
    run_transitions = []
